<x-app-layout title="My Cars" className="my-page-cars">
     <main>
      <div class="container">
        <h1 class="car-details-page-title">{{$car->maker->name}} {{$car->model->name}} - {{$car->year}}</h1>
        <div class="car-details-region">{{$car->city->name}} - {{Carbon\Carbon::parse($car->published_at)->diffForHumans()}}</div>
        ...
        <div class="car-details-content">
          ...
          <div class="car-details card">
            ...
            <a href="tel:{{$car->owner->phone}}" class="car-details-phone">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
