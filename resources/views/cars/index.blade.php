...
<x-app-layout title="My Cars" className="page-my-cars">
     <main>
      <div>
        <div class="container">
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  ...
                  @empty
                  <tr>
                    <td colspan="5" class="text-center">No cars found. Please <a href="{{route('cars.create')}}" class="text-blue-500">create</a> a new car.</td>
                  </tr>
                  @endforelse
                </tbody>
              </table>
